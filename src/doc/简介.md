...
主数据平台（master-data-platform），简称**MDP**、**mddata**。是聚合**全域单点登录中心、基础数据治理平台、统一开放接口平台**于一体的企业级通用底层开发框架。
...
| 名称     | 项目名                                                       | 备注                                   |
| -------- | ------------------------------------------------------------ | -------------------------------------- |
| 工具类   | [mdp-core](https://gitee.com/henhen6/mddata/tree/master/mdp-core) | 后端工具类                             |
| Java后端 | [mdp-platform](https://gitee.com/henhen6/mddata/tree/master/mdp-platform) | 后端业务代码，支持单体架构和微服务架构 |
