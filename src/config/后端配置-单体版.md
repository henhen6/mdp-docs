...
**Q2：单体版怎么连的 Nacos？明明没有微服务？**

单体版打包时同样使用 filters 编译期配置连接注册中心（boot-server 的 pom 同样声明了 filter）。开发环境默认使用 zookeeper 作为注册中心，测试/生产使用 nacos。

**Q3：想临时禁用验证码快速登录，要改哪里？**
